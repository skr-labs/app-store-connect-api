...
export class AppStoreVersionExperimentTreatmentLocalizationsApi {
  ...
  public setApiKey(
    ...
    (this.authentications as any)[
      AppStoreVersionExperimentTreatmentLocalizationsApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async appStoreVersionExperimentTreatmentLocalizationsAppPreviewSetsGetToManyRelated(
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appPreviewSets".replace(
        "{" + "id" + "}",
    ...
    if (filterAppCustomProductPageLocalization !== undefined) {
      localVarQueryParameters["filter[appCustomProductPageLocalization]"] =
        ObjectSerializer.serialize(
   ...
   * @param include comma-separated list of relationships to include
   */
  public async appStoreVersionExperimentTreatmentLocalizationsAppScreenshotSetsGetToManyRelated(
    id: string,
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionExperimentTreatmentLocalizations/{id}/appScreenshotSets".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
  ...
  public async appStoreVersionExperimentTreatmentLocalizationsCreateInstance(
    ...
    const localVarPath =
      this.basePath + "/v1/appStoreVersionExperimentTreatmentLocalizations";
    let localVarQueryParameters: any = {};
    let localVarHeaderParams: any = (<any>Object).assign(
      {},
      this._defaultHeaders
    ...
    if (
      appStoreVersionExperimentTreatmentLocalizationCreateRequest === null ||
      appStoreVersionExperimentTreatmentLocalizationCreateRequest === undefined
    ) {
      throw new Error(
   ...
   * @param id the id of the requested resource
   */
  public async appStoreVersionExperimentTreatmentLocalizationsDeleteInstance(
    id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionExperimentTreatmentLocalizations/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async appStoreVersionExperimentTreatmentLocalizationsGetInstance(
    id: string,
    fieldsAppStoreVersionExperimentTreatmentLocalizations?: Array<
      | "appPreviewSets"
      | "appScreenshotSets"
