...
export class AppStoreVersionLocalizationsApi {
  ...
  public setApiKey(key: AppStoreVersionLocalizationsApiApiKeys, value: string) {
    (this.authentications as any)[
      AppStoreVersionLocalizationsApiApiKeys[key]
    ].apiKey = value;
  }
  ...
  public async appStoreVersionLocalizationsAppPreviewSetsGetToManyRelated(
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionLocalizations/{id}/appPreviewSets".replace(
        "{" + "id" + "}",
   ...
   * @param include comma-separated list of relationships to include
   */
  public async appStoreVersionLocalizationsAppScreenshotSetsGetToManyRelated(
    id: string,
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionLocalizations/{id}/appScreenshotSets".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async appStoreVersionLocalizationsCreateInstance(
    ...
    if (
      appStoreVersionLocalizationCreateRequest === null ||
      appStoreVersionLocalizationCreateRequest === undefined
    ) {
      throw new Error(
   ...
   * @param id the id of the requested resource
   */
  public async appStoreVersionLocalizationsDeleteInstance(
    id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath =
      this.basePath +
      "/v1/appStoreVersionLocalizations/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async appStoreVersionLocalizationsGetInstance(
    id: string,
    fieldsAppStoreVersionLocalizations?: Array<
      | "appPreviewSets"
      | "appScreenshotSets"
    ...
    if (include !== undefined) {
      localVarQueryParameters["include"] = ObjectSerializer.serialize(
        include,
        "Array<'appPreviewSets' | 'appScreenshotSets' | 'appStoreVersion'>"
      );
    }
   ...
   */
  public async appStoreVersionLocalizationsUpdateInstance(
    id: string,
    ...
    if (
      appStoreVersionLocalizationUpdateRequest === null ||
      appStoreVersionLocalizationUpdateRequest === undefined
    ) {
      throw new Error(
