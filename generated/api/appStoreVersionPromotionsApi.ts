...
export class AppStoreVersionPromotionsApi {
  ...
  public setApiKey(key: AppStoreVersionPromotionsApiApiKeys, value: string) {
    (this.authentications as any)[
      AppStoreVersionPromotionsApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async appStoreVersionPromotionsCreateInstance(
    ...
    if (
      appStoreVersionPromotionCreateRequest === null ||
      appStoreVersionPromotionCreateRequest === undefined
    ) {
      throw new Error(
