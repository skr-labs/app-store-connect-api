...
export class AppStoreReviewDetailsApi {
  ...
  public setApiKey(key: AppStoreReviewDetailsApiApiKeys, value: string) {
    (this.authentications as any)[AppStoreReviewDetailsApiApiKeys[key]].apiKey =
      value;
  }
  ...
  public async appStoreReviewDetailsAppStoreReviewAttachmentsGetToManyRelated(
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreReviewDetails/{id}/appStoreReviewAttachments".replace(
        "{" + "id" + "}",
   ...
   */
  public async appStoreReviewDetailsCreateInstance(
    ...
    if (
      appStoreReviewDetailCreateRequest === null ||
      appStoreReviewDetailCreateRequest === undefined
    ) {
      throw new Error(
   ...
   */
  public async appStoreReviewDetailsGetInstance(
    id: string,
    fieldsAppStoreReviewDetails?: Array<
      | "appStoreReviewAttachments"
      | "appStoreVersion"
    ...
    const localVarPath =
      this.basePath +
      "/v1/appStoreReviewDetails/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async appStoreReviewDetailsUpdateInstance(
    id: string,
    ...
    if (
      appStoreReviewDetailUpdateRequest === null ||
      appStoreReviewDetailUpdateRequest === undefined
    ) {
      throw new Error(
