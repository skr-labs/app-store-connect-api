...
export class BetaLicenseAgreementsApi {
  ...
  public setApiKey(key: BetaLicenseAgreementsApiApiKeys, value: string) {
    (this.authentications as any)[BetaLicenseAgreementsApiApiKeys[key]].apiKey =
      value;
  }
   ...
   */
  public async betaLicenseAgreementsAppGetToOneRelated(
    id: string,
    fieldsApps?: Array<
      | "appClips"
    ...
    const localVarPath =
      this.basePath +
      "/v1/betaLicenseAgreements/{id}/app".replace(
        "{" + "id" + "}",
   ...
   * @param fieldsApps the fields to include for returned resources of type apps
   */
  public async betaLicenseAgreementsGetInstance(
    id: string,
    fieldsBetaLicenseAgreements?: Array<"agreementText" | "app">,
    include?: Array<"app">,
    fieldsApps?: Array<
    ...
    const localVarPath =
      this.basePath +
      "/v1/betaLicenseAgreements/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async betaLicenseAgreementsUpdateInstance(
    id: string,
    ...
    if (
      betaLicenseAgreementUpdateRequest === null ||
      betaLicenseAgreementUpdateRequest === undefined
    ) {
      throw new Error(
