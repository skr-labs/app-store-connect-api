...
export class DiagnosticSignaturesApi {
  ...
  public setApiKey(key: DiagnosticSignaturesApiApiKeys, value: string) {
    (this.authentications as any)[DiagnosticSignaturesApiApiKeys[key]].apiKey =
      value;
  }
   ...
   */
  public async diagnosticSignaturesLogsGetToManyRelated(
    id: string,
    limit?: number,
    ...
    const localVarPath =
      this.basePath +
      "/v1/diagnosticSignatures/{id}/logs".replace(
        "{" + "id" + "}",
