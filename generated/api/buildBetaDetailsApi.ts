...
export class BuildBetaDetailsApi {
  ...
  public setApiKey(key: BuildBetaDetailsApiApiKeys, value: string) {
    (this.authentications as any)[BuildBetaDetailsApiApiKeys[key]].apiKey =
      value;
  }
  ...
  public async buildBetaDetailsBuildGetToOneRelated(
    ...
    const localVarPath =
      this.basePath +
      "/v1/buildBetaDetails/{id}/build".replace(
        "{" + "id" + "}",
  ...
  public async buildBetaDetailsGetInstance(
    ...
    const localVarPath =
      this.basePath +
      "/v1/buildBetaDetails/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   */
  public async buildBetaDetailsUpdateInstance(
    id: string,
    ...
    if (
      buildBetaDetailUpdateRequest === null ||
      buildBetaDetailUpdateRequest === undefined
    ) {
      throw new Error(
