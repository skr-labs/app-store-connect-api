...
export enum AppPricesApiApiKeys {}

export class AppPricesApi {
  ...
  public setApiKey(key: AppPricesApiApiKeys, value: string) {
    (this.authentications as any)[AppPricesApiApiKeys[key]].apiKey = value;
  }
   ...
   */
  public async appPricesGetInstance(
    id: string,
    fieldsAppPrices?: Array<"app" | "priceTier">,
    include?: Array<"app" | "priceTier">,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body: AppPriceResponse }> {
    const localVarPath =
      this.basePath +
      "/v1/appPrices/{id}".replace(
        "{" + "id" + "}",
    ...
    if (id === null || id === undefined) {
      throw new Error(
        "Required parameter id was null or undefined when calling appPricesGetInstance."
      );
    }
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(body, "AppPriceResponse");
