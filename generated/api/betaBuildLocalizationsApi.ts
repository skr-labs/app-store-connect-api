...
export class BetaBuildLocalizationsApi {
  ...
  public setApiKey(key: BetaBuildLocalizationsApiApiKeys, value: string) {
    (this.authentications as any)[
      BetaBuildLocalizationsApiApiKeys[key]
    ].apiKey = value;
  }
   ...
   */
  public async betaBuildLocalizationsBuildGetToOneRelated(
    id: string,
    fieldsBuilds?: Array<
      | "app"
    ...
    const localVarPath =
      this.basePath +
      "/v1/betaBuildLocalizations/{id}/build".replace(
        "{" + "id" + "}",
   ...
   */
  public async betaBuildLocalizationsCreateInstance(
    ...
    if (
      betaBuildLocalizationCreateRequest === null ||
      betaBuildLocalizationCreateRequest === undefined
    ) {
      throw new Error(
   ...
   * @param id the id of the requested resource
   */
  public async betaBuildLocalizationsDeleteInstance(
    id: string,
    options: { headers: { [name: string]: string } } = { headers: {} }
  ): Promise<{ response: http.IncomingMessage; body?: any }> {
    const localVarPath =
      this.basePath +
      "/v1/betaBuildLocalizations/{id}".replace(
        "{" + "id" + "}",
        encodeURIComponent(String(id))
      );
    let localVarQueryParameters: any = {};
   ...
   * @param fieldsBuilds the fields to include for returned resources of type builds
   */
  public async betaBuildLocalizationsGetInstance(
    id: string,
    fieldsBetaBuildLocalizations?: Array<"build" | "locale" | "whatsNew">,
    include?: Array<"build">,
    fieldsBuilds?: Array<
   ...
   */
  public async betaBuildLocalizationsUpdateInstance(
    id: string,
    ...
    if (
      betaBuildLocalizationUpdateRequest === null ||
      betaBuildLocalizationUpdateRequest === undefined
    ) {
      throw new Error(
